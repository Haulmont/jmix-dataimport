...
class CsvDataExtractorTest extends DataImportSpec {
    ...
    def "test imported data from input stream"() {
        ...
        ImportConfiguration importConfiguration = new ImportConfiguration(Product, "products-from-csv");
    ...
    def "test import from byte array"() {
        ...
        when: 'imported data extracted'
        def importedData = csvDataExtractor.extract(csvString.getBytes(), new ImportConfiguration(Product, 'products'))
    ...
    def "test unsupported encoding"() {
        ...
        when: 'imported data extracted'
        csvDataExtractor.extract(inputStream, importConfiguration)
