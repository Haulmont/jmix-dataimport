...
public class CreatedAssociation {
    ...
    public CreatedAssociation setCreatedObject(Object createdObject) {
    ...
    public CreatedAssociation setOwnerEntity(Object ownerEntity) {
    ...
    public CreatedAssociation setPropertyMapping(PropertyMapping propertyMapping) {
