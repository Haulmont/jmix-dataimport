...
@Component("datimp_SimplePropertyBinder")
public class SimplePropertyBinder implements PropertyBinder {
    @Autowired
    ...
    public void bindProperty(Object entityToPopulate, PropertyBindingContext context) {
        ...
        Object propertyValue = simplePropertyValueProvider.getValue(rawValue, context.getOwnerEntityMetaClass(), propertyMapping, context.getImportConfiguration());
        EntityValues.setValue(entityToPopulate, propertyMapping.getPropertyName(), propertyValue);
    }
}
